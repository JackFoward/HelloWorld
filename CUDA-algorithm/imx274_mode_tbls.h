...
static const imx274_reg imx274_mode3_1920x1080_raw10[] = {
	...
	{0x3006, 0x00},
	{0x3007, 0x11},
	{0x300C, 0xff}, // SHR, debug priority #4 not done
	{0x300D, 0x00}, // SHR
	{0x300E, 0x00},//0x01}, // SVR, 1, reduce from 120fps to 60fps, debug priority #3 not done
	{0x300F, 0x00}, // SVR
	{0x3018, 0xA2}, // output XVS, HVS
	{0x301A, 0x00},
	{0x306B, 0x05},
	...
	{0x30F7, 0x01}, // HMAX
	{0x30F8, 0x0C}, // VMAX , 4620 , original 0x06 , 2310, debug priority #2 not done
	{0x30F9, 0x12}, // VMAX		 original 0x09
	{0x30FA, 0x00}, // VMAX

	{0x30dd, 0x01}, // to crop to 1920x1080, debug priority #5 not done
	{0x30de, 0x0b},
	{0x30df, 0x00},
	{0x30e0, 0x06},
	{0x30e1, 0x00},
	...
	{0x3344, 0x1A},
	{0x3345, 0x00},
	{0x33A6, 0x01}, // original 0x00, debug priority #1 not done
	{0x3528, 0x0E},
	{0x3554, 0x00},
	{0x3555, 0x01},
	{0x3556, 0x01},
...
// raw 10, mode 6
static const imx274_reg imx274_mode6_1280x540_raw10[] = {
	{0x3004, 0x04},
	{0x3005, 0x31},
	{0x3006, 0x00},
	{0x3007, 0x02},
	...
	{0x30dd, 0x01}, // to crop to 1280x540
	{0x30de, 0x02},
	{0x30df, 0x00},
	{0x30e0, 0x01},
	{0x30e1, 0x00},
...
static const imx274_reg imx274_start_2[] = {
	...
	{0x30EE, 0x01}, // newly added, debug priority #6 not done
...
static const imx274_reg *mode_table[] = {
	...
	[IMX274_MODE_1280X540] 			= imx274_mode6_1280x540_raw10,
...
static const int imx274_240fps[] = {
	240,
};
...
static const struct camera_common_frmfmt imx274_frmfmt[] = {
	...
	{{1280, 540},	imx274_240fps, 1, 0, IMX274_MODE_1280X540},
};
